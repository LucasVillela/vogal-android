...
import br.com.vogal.service.AuthService;
import br.com.vogal.service.SessionService;
...
//        }
        ...
        if (cancel) {
            ...
            authService.login(email, password).enqueue(handleLogin());
    ...
    private Callback<User> handleLogin(){
        return new Callback<User>(){
            @Override
            public void onResponse(Call<User> call, Response<User> response) {
                sessionService.createSession(response.body());
